<div class="wrap">
    <h1><?php _e( 'New Address', 'we-crud' ); ?> </h1>
    <form action="" method="post">
            ...
            <tbody>
               <tr class="row<?php echo $this->has_error( 'name' ) ? ' form-invalid' : '' ;?>">
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="address" class="regular-text" name="address" id="address"></textarea>
                    </td>
                </tr>
        ...
        <?php submit_button( __( 'Add Address', 'we-crud' ), 'primary', 'submit_address' ); ?>
    </form>
</div>