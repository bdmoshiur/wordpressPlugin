...
class Subscription_Form_Setting {
    ...
    public function render_api_field( ) {
        ...
        echo '<input type="text" class="widefat" name="mailchimp_link" value="' . esc_attr__( $mailchimp_link, 'my-subscription-form' ) . '" placeholder="' .  __( 'Enter your api key', 'my-subscription-form' ) . '">';
    }
}
