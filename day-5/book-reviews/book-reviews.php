 ...
 * Description:       Book review with this plugin.
 * Version:           1.0.0
...
class Mrm_Book_Reviews {
    ...
    public function mrm_book_reviews_init() {
        $labels = [
            ...
            'parent_item_colon'     => __( 'Parent Books:', 'book-reviews' ),
        ...
        <?php wp_nonce_field( 'book_reviews_meta_box_information', 'book_reviews_nonce' ); ?>
            <div class="row">
                <div class="col-md-3 form-group">
                    <label for="bookName" class="form-label"><?php esc_html_e( 'Book Name', 'book-reviews' ); ?></label>
                ...
                <div class="col-md-3 form-group">
                    <label for="bookPublish" class="form-label"><?php  esc_html_e( 'Book Publish Date', 'book-reviews' ); ?></label>
                    <input type="date" class="form-control widefat" id="bookPublish" value="<?php esc_attr_e( $book_date_show ); ?>" name="date">
                </div>
                <div class="col-md-2 form-group">
                    <label for="bookCode" class="form-label"><?php esc_html_e( 'Zip', 'book-reviews' ); ?></label>
                    <input type="text" class="form-control widefat" id="bookCode" name="code" value="<?php esc_attr_e( $book_code_show ); ?>" placeholder="Code">
                </div>
                <div class="col-md-3 form-group">
                    <label for="authorName" class="form-label"><?php  esc_html_e( 'Author Name', 'book-reviews' ); ?></label>
                ...
                <div class="col-md-6 form-group">
                    <label for="bookEmail" class="form-label"><?php  esc_html_e( 'Author Email', 'book-reviews' ); ?></label>
                ...
                <div class="col-12 form-group">
                    <label for="authorAddress" class="form-label"><?php  esc_html_e( 'Author Address', 'book-reviews' ); ?></label>
